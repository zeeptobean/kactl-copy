...
\kactlimport{vuhieuComb.h}
\kactlimport{BitmaskUtil.h}
\kactlimport{SumOfSubset.h}
...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		\begin{itemize}
			\item \lstinline{#pragma GCC optimize ("Ofast")} go brrr
			\item \lstinline{#pragma GCC target ("avx2")}
			\item \lstinline{#pragma GCC optimize ("trapv")} kills the program on integer overflows
		\end{itemize}
	\kactlimport{FastMod.h}
	\kactlimport{FastInput.h}
	\kactlimport{Int128Helper.h}
	\kactlimport{BumpAllocator.h}
	% \kactlimport{SmallPtr.h}
	% \kactlimport{BumpAllocatorSTL.h}
	% \kactlimport{Unrolling.h}
	\kactlimport{IncreaseStackSize.h}
	% \kactlimport{SIMD.h}

	\kactlimport{c_cpp_properties.json}
	\kactlimport{launch.json}
